      ...
      <div className="p-2 overflow-y-scroll h-fit">
        ...
        {menu <= 1 && examples?.length && (
          <div className="h-full flex flex-col">
            ...
            <div className={""}>
              <div className="p-1">
                {data?.output?.testCasesResult?.[caseNumber] == true && (
                  <h1 className="w-fit px-2 py-1 rounded text-green-600 font-semibold bg-green-400 bg-opacity-30">correct</h1>
                )}
                {data?.output?.testCasesResult?.[caseNumber] == false && (
                  <h1 className="w-fit px-2 py-1 rounded text-red-600 font-semibold bg-red-400 bg-opacity-30">wrong</h1>
                )}
              </div>
              ...
              {menu == 1 && (
                <>
                  ...
                  <h2 className="min-h-8 cursor-pointer px-2 py-1.5 border rounded border-blue-500 bg-neutral-100">
                    ...
                    {data?.output?.testcaseOutput?.[caseNumber]}
                  </h2>
                </>
              )}
            </div>
